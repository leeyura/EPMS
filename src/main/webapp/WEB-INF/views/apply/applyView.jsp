  ...
  <div id="epRegister-page" class="row">
    ...
    <div class="col s12 m4 l4 card-panel">
	      <form>
	          ...
	          <div class="input-field col s12">
   					<div class="select-wrapper initialized">
						<span class="caret">▼</span> <select class="initialized">
							...
							<option value="0" selected="selected">페퍼민트허브차</option>
	        ...
	        <div class="row margin">
	          <div class="input-field col s12">
	            <input id="epCnt" type="text" placeholder="비품신청수량" value="1개">
	          </div>
	        </div>

	        <div class="row">
	          <div class="input-field col s12">
	            <a href="index.html" class="btn waves-effect waves-light col s12">수정하기</a>
	          </div>
