        ...
        <div class="navbar-fixed">
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    <ul class="left">                      
                      <li><h1 class="logo-wrapper"><a href="index.html" class="brand-logo darken-1"><img src="http://demo.geekslabs.com/materialize-v1.0/images/materialize-logo.png" alt="materialize logo"></a> <span class="logo-text">Materialize</span></h1></li>
                    </ul>
	                ...
	                <li class="user-details cyan darken-2">
      	                <div class="row">
		                    <div class="col col s4 m4 l4">
		                        <img src="http://demo.geekslabs.com/materialize-v1.0/images/avatar.jpg" alt="" class="circle responsive-img valign profile-image">
		                    </div>
					 ...
					 <li class="bold active"><a href="index.html" class="waves-effect waves-cyan"><i class="small material-icons">insert_chart</i> Dashboard</a>
					 <li class="bold active"><a href="index.html" class="waves-effect waves-cyan"><i class="small material-icons">label_outline</i> Buy</a>
					 <li class="bold active"><a href="index.html" class="waves-effect waves-cyan"><i class="small material-icons">insert_chart</i> Dashboard</a>
	                </li>
<!-- 	                <li class="no-padding">
	                    <ul class="collapsible collapsible-accordion">
	                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="small label_outline"></i> Layouts </a>
	                ...
	                <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="small material-icons">label_outline</i> Buy</a>
